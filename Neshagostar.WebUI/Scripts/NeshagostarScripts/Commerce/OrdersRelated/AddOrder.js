$(function () {
    ...
    $("form").validate({   /// binding validation properties to form
        ...
        messages: {
            ...
            ProductName: "لطفا نام محصول را وارد فرمائید",
            Amount: "لطفا متراژ را وارد فرمائید",
            PricePerUnit: "لطفا قیمت یک متر را وارد فرمائید",
...
function getProductsChosenBefore(orderId) {
    return $.ajax({
        type: "GET",
        url: "/commerce/Orders/getProductsChosen",
