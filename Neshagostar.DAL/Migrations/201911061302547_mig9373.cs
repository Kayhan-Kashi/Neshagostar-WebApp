namespace Neshagostar.DAL.Migrations
{
    ...
    public partial class mig9373 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Title = c.String(),
                        PredictionPrice = c.Double(nullable: false),
                        ParticipatingGuarantyPrice = c.Double(nullable: false),
                        GuarantyCost = c.Double(nullable: false),
                        CarriageCost = c.Double(nullable: false),
                        InspectionCost = c.Double(nullable: false),
